...
namespace SharpUI.Source.Common.UI.Elements.List
{
    ...
    public class ListView : MonoBehaviour
    {
        ...
        {
            if(_adapter!= null) _adapter.SetCanClickItems(canClickItems);
            if(_adapter!= null) _adapter.SetCanSelectItems(canSelectItems);
            if(_adapter!= null) _adapter.SetItemsEnabled(enableItems);
        }
